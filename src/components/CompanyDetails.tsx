            ...
            <div className="p-5 md:p-6 space-y-5 text-sm">
              ...
              <div className="space-y-3 font-mono text-xs">
                ...
                <div className="flex flex-col sm:flex-row sm:items-baseline gap-1 sm:gap-3">
                  ...
                  <a href="mailto:hello@goatlabs.dev" className="text-foreground/90 hover:text-primary transition-colors">
                    hello@goatlabs.dev
                  </a>
                </div>
                <div className="flex flex-col sm:flex-row sm:items-baseline gap-1 sm:gap-3">
                  <span className="text-muted-foreground shrink-0 w-28">phone</span>
                  <a href="tel:+48000000000" className="text-foreground/90 hover:text-primary transition-colors tabular-nums">
                    +48 000 000 000
                  </a>
                </div>
              </div>
